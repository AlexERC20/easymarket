...
`USDT_WITHDRAWAL_FEE` is deducted from each withdrawal request. USDT withdrawal is available only after a confirmed on-chain deposit, and bonus conversion additionally requires at least one cash-backed USDT prediction.
