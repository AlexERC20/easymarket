...
export function getConfiguredUsdtDepositNetworks() {
  return [
    buildEvmNetwork({
      ...
      explorerApiUrl: config.usdtBscExplorerApiUrl || config.evmScanApiUrl,
      explorerApiKey: config.usdtBscExplorerApiKey || config.evmScanApiKey,
    ...
    buildEvmNetwork({
      ...
      explorerApiUrl: config.usdtEthExplorerApiUrl || config.evmScanApiUrl,
      explorerApiKey: config.usdtEthExplorerApiKey || config.evmScanApiKey,
