...
export const config = {
  ...
  databaseCleanupRunOnStart: parseBoolean(process.env.DATABASE_CLEANUP_RUN_ON_START, true),
  databaseCleanupIntervalMs: parseNumber(process.env.DATABASE_CLEANUP_INTERVAL_MS, 86_400_000, 60_000),
  databaseCleanupVacuum: parseBoolean(process.env.DATABASE_CLEANUP_VACUUM, true),
  cleanupPriceTicksHours: parseNumber(process.env.CLEANUP_PRICE_TICKS_HOURS, 48, 1),
