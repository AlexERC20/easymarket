...
export const config = {
  ...
  // Адрес общий, V2: классический эндпоинт BscScan закрыт («deprecated V1»),
  // так что путь для сети 56 только один. Разделение здесь нужно ради КЛЮЧА —
  // отдельный ключ BscScan покрывает свою сеть там, где общий отвечает
